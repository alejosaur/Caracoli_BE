...
class HarvestLotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create harvest_lot" do
    assert_difference('HarvestLot.count') do
      post harvest_lots_url, params: { harvest_lot: { harvest_id: @harvest_lot.harvest_id, lot_id: @harvest_lot.lot_id } }, as: :json
    end
  ...
  test "should update harvest_lot" do
    patch harvest_lot_url(@harvest_lot), params: { harvest_lot: { harvest_id: @harvest_lot.harvest_id, lot_id: @harvest_lot.lot_id } }, as: :json
    assert_response 200
  end
